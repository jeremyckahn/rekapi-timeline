...
import CurveSelector from 'aenima/components/curve-selector/main'
...
const KeyframePropertyDetailComponentView = Base.extend({
  ...
  render() {
    ...
    this.$propertyMillisecond.val(this.keyframePropertyModel.get('millisecond'))
...
export default KeyframePropertyDetailComponentView
